// src/pages/auth/ForgotPassword.jsx — Fully responsive
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fp-btn:hover:not(:disabled) { background:#1F2937!important; }
      ...
      {!isMobile && (
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32 }}>
            ...
            <div>
              <div style={{ fontSize: 28, fontWeight: 700, color: "#111827" }}>HostelEase</div>
              <div style={{ fontSize: 13, color: "#6B7280" }}>Account recovery</div>
            </div>
          </div>

          <h1 style={{ fontSize: 56, fontWeight: 800, color: "#111827",
          ...
          <div style={{ background: "rgba(255,255,255,0.72)", border: "1px solid rgba(255,255,255,0.9)",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 800, color: "#2563EB",
                textTransform: "uppercase", letterSpacing: "0.1em" }}>Security Note</span>
            </div>
            <p style={{ fontSize: 14, color: "#374151", lineHeight: 1.6 }}>
              If the email exists, you'll receive a reset link. We won't reveal account details.
            </p>
          </div>
        </div>
      )}
      ...
      <div style={{
        ...
        padding: isMobile ? "32px 20px 48px" : "48px 52px",
        display: "flex", flexDirection: "column",
        ...
        {isMobile && (
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 32 }}>
            <div style={{ width: 40, height: 40, borderRadius: 12, background: "#111827",
        ...
        {status !== "success" ? (
          <>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="fp-field"
                style={{ display: "flex", alignItems: "center",
                  ...
                  transition: "border-color .15s, box-shadow .15s", marginBottom: 8 }}>
            ...
            <p style={{ marginTop: 28, fontSize: 12, color: "#D1D5DB",
              textAlign: "center", lineHeight: 1.5 }}>
              Tip: check spam/junk folder if you don't receive the email.
            </p>
          </>
        ) : (
          /* Success state */
          <div style={{ textAlign: "center", animation: "fp-fade .4s ease both" }}>
            ...
            <div style={{ background: "#F9FAFB", border: "1px solid #E5E7EB",
              ...
              <strong style={{ color: "#374151" }}>check your spam folder.</strong>
