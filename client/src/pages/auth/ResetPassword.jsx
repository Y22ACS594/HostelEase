// src/pages/auth/ResetPassword.jsx — Fully responsive
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rp-btn:hover:not(:disabled) { background:#1F2937!important; }
      `}</style>
          ...
          <div style={{ background: "rgba(255,255,255,0.72)", border: "1px solid rgba(255,255,255,0.9)",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 800, color: "#7C3AED",
                textTransform: "uppercase", letterSpacing: "0.1em" }}>Password Tips</span>
            </div>
        ...
        {status !== "success" ? (
          <>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="rp-field">
                ...
                <input type={showPass ? "text" : "password"} name="password"
                  ...
                  style={{ flex: 1, padding: "13px 14px", border: "none", outline: "none",
                    fontSize: showPass ? 14 : 16, color: "#111827", background: "transparent",
                    fontFamily: "'Sora',sans-serif",
                    letterSpacing: showPass ? "normal" : "0.1em", minHeight: 50 }}/>
              ...
              {/* Confirm Password */}
              <label style={{ fontSize: 14, fontWeight: 600, color: "#111827",
                display: "block", marginBottom: 8 }}>Confirm your new password</label>
              <div className="rp-field">
                <span style={{ padding: "0 14px", color: "#9CA3AF", flexShrink: 0,
                  display: "flex", alignItems: "center" }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                ...
                <input type={showConf ? "text" : "password"} name="confirmPassword"
                  ...
                  style={{ flex: 1, padding: "13px 14px", border: "none", outline: "none",
                    fontSize: showConf ? 14 : 16, color: "#111827", background: "transparent",
                    fontFamily: "'Sora',sans-serif",
                    letterSpacing: showConf ? "normal" : "0.1em", minHeight: 50 }}/>
              ...
              <button type="submit" disabled={status === "loading"} className="rp-btn"
