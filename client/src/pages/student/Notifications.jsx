// src/pages/student/Notifications.jsx — Fully responsive
...
if (!document.getElementById("sn-font")) {
  const l = document.createElement("link");
  l.id = "sn-font"; l.rel = "stylesheet";
...
const FILTERS = ["All", "Unread", "Leave", "Room"];
...
export default function StudentNotifications() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: P.surface, fontFamily: "'Sora',sans-serif",
        ...
        <div style={{ background: "#fff", borderBottom: `1px solid ${P.border}`,
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button onClick={() => navigate("/student/dashboard")}
              style={{ padding: "8px 14px", background: "#F9FAFB", border: `1px solid ${P.border}`,
                borderRadius: 10, fontSize: 13, cursor: "pointer", color: P.muted, fontFamily: "'Sora',sans-serif" }}>
              ← Back
            </button>
            <div>
              <div style={{ fontSize: 11, color: P.primary, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" }}>Student Portal</div>
      ...
      <div style={{ maxWidth: isMobile ? "100%" : 720, margin: "0 auto",
        ...
        {isMobile && (
          <div style={{ padding: "0 16px 12px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            {unread > 0 && (
              <button onClick={handleMarkAll}
                style={{ fontSize: 12, color: P.primary, fontWeight: 600, background: "#EFF6FF",
                  border: "none", padding: "6px 12px", borderRadius: 8, cursor: "pointer", fontFamily: "'Sora',sans-serif" }}>
                ✓ All read
              </button>
            )}
          </div>
      ...
      <style>{`div:hover > .notif-del { opacity: 1 !important; } .notif-del:hover { background: #FEE2E2 !important; color: #DC2626 !important; }`}</style>
    </div>
  );
}
